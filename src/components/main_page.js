        ...
        <div className='main_Main'>
            ...
            <div className='statusbar'>
                ...
                <div className='BMIDiv' onClick={BMIClickHandler}>
                    ...
                    {BMI >= 35 && [<p>Extremely Obese</p>, <img alt='' src={Extreamly} />]}
                </div>
            ...
            <div className='main_divider' />
                ...
                <div className= {mealThree_box ? 'meal_popup': 'meal_popup hidden'}>
                    <div className='meal_popupElement'>
                        ...
                        <div className='text_scroll'>
                            <h2>Ingredients:</h2>
                            <p>{Math.round(((mealThreeCals * 0.5) / 1.85) / 64)} wraps, {Math.round((mealThreeCals * 0.3) / 1.65)}g precooked chicken breast, {Math.round((mealThreeCals * 0.25) / 1.1)}g of vegetables and greens(peppers, mushrooms, onions, lettuce and spinach etc...) and a drizzle of franks red hot sauce.</p>
                            <h2>Method:</h2>
                            <p>Fill the wraps with a base layer lettuce and vegetables. Then place the chicken breast on to and drizzle with franks red hot sauce and pepper before assembling the wrap.</p>
                        </div>
                    </div>
                ...
                <div className={BMI_box ? 'meal_popup': 'meal_popup hidden'}>
                    <div className='status_popupElement'>
                        ...
                        <div className='text_scroll'>
                            ...
                            {BMI > 18.5 && BMI < 25 && <p>You are within the healthy range, this is a good sign as it decrease the risk of heart attacks, strokes, diabetes and cancers. People in the healthy range of BMI can still often have a body fat percentage higher than is considered unhealthy. It is recommended that you recomposition by eating at maintenance calories and exercise to decrease body-fat and increase lean muscle tissue.</p>}

                            {BMI >= 25 && BMI < 30 && <p>You are overweight. This is not a good sign for long term health your risk of heart attacks, strokes, diabetes of cancers is increased. High levels of muscle mass will cause BMI to be inaccurate, although if you cannot see your abs or any muscle definition for overall health it is recommended that you cut body-fat and drop to a normal BMI.</p>}
                            ...
                            {BMI >= 35 && <p>You are extremely obese, this is very unhealthy. The risk of getting diabetes, cancers, strokes and heart attacks is enormously increased. It is strongly recommended for overall health that you cut body-fat and drop to a normal BMI, using exercise and a calorie deficit.</p>}
                        </div>
                    </div>
                ...
                <div className={Cals_box ? 'meal_popup': 'meal_popup hidden'}>
                    <div className='status_popupElement'>
                        ...
                        <div className='text_scroll'>
                            ...
                            {healthData.goal === 'Gain' && [<p>You are currently eating at a {Math.round(BMR - (BMR / 1.2))} calorie surplus. This means you are consuming more calories than your body requires with in a day and will put on weight.</p>,
                            <h2>Why?</h2>,
                            ...
                            <h2>Why?</h2>,
                            <p> When combined with a weight training program prioritising progressive overload and regular steady state cardio your body will recomposition. This mean a larger percentage of the calories you consume will be used to be build muscle instead of being stored as fat this also known as "Maingaining". In the the long term you'll have a lower body fat percentage and more muscle mass at the same body weight.</p>]}
